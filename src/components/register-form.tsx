        ...
        <div className="flex min-h-screen items-center justify-center bg-background p-4">
            <div className="flex w-full max-w-4xl overflow-hidden rounded-lg border bg-card shadow-lg">
                <form
                    ...
                    className={cn(
                        'flex w-full md:w-1/2 flex-col gap-6 p-8',
                        className
                    )}
                    {...props}
                >
                    ...
                    <div className="flex gap-4">
                        <div className="flex-1">
                            <Label htmlFor="firstName" className="mb-2 block">Nome</Label>
                            <Input
                                id="firstName"
                                value={firstName.charAt(0).toUpperCase() + firstName.slice(1).toLowerCase()}
                        ...
                        <div className="flex-1">
                            <Label htmlFor="lastName" className="mb-2 block">Cognome</Label>
                            <Input
                                id="lastName"
                    ...
                    {modalOpen && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                            <div className="w-80 rounded-lg bg-card p-6 text-center shadow-lg">
                                <h2 className="mb-4 text-xl font-bold">Registrazione riuscita!</h2>
